# ruff: noqa
"""
FastMCP Cloud entrypoint for the Google Docs MCP server.
...
# Enable docs and drive tools
set_enabled_tools(["docs", "drive"])

# Import tools to register their @server.tool() decorators
...
# Note: OpenAI Apps SDK routes are automatically enabled in configure_server_for_http()
# when OPENAI_APPS_SDK_ENABLED=true (default)
logger.info("FastMCP Cloud entrypoint configured with OpenAI Apps SDK support")
