"""
Core Comments Module for Google Docs

This module provides comment management functions for Google Docs.
Uses the Drive API for comment operations.
"""
...
def create_comment_tools(app_name: str, file_id_param: str):
    """
    Factory function to create comment management tools for Google Docs.

    Args:
        app_name: Name of the app (should be "document")
        file_id_param: Parameter name for the file ID (should be "document_id")
...
async def _read_comments_impl(service, app_name: str, file_id: str) -> str:
    """Implementation for reading comments from a Google Doc."""
...
async def _create_comment_impl(
    ...
    """Implementation for creating a comment on a Google Doc."""
...
async def _reply_to_comment_impl(
    ...
    """Implementation for replying to a comment on a Google Doc."""
    logger.info(
...
async def _resolve_comment_impl(
    ...
    """Implementation for resolving a comment on a Google Doc."""
    logger.info(
