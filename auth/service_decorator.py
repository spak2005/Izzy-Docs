...
# Service configuration mapping (only docs and drive needed)
SERVICE_CONFIGS = {
...
# Scope group definitions for docs
SCOPE_GROUPS = {
    # Drive scopes (needed for docs operations)
...
def require_google_service(
    ...
    Args:
        service_type: Type of Google service ("docs", "drive")
